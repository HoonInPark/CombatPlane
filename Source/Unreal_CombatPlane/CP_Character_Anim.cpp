...
void ACP_Character_Anim::PropellerTypeTick_Implementation(FPawnMovement _pPawnMovement)
{
}

void ACP_Character_Anim::JetEngineTypeTick_Implementation(FPawnMovement _pPawnMovement)
{
}
